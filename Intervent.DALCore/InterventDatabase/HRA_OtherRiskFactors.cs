namespace Intervent.DAL
{
    ...
    public partial class HRA_OtherRiskFactors
    {
        ...
        public byte? CancerHist { get; set; }

        public byte? DiabetesHist { get; set; }

        public byte? SmokeCig { get; set; }

        public float? NoOfCig { get; set; }

        public byte? SmokeHist { get; set; }
        ...
        public byte? PhysicalProb { get; set; }

        public byte? Arthritis { get; set; }

        public byte? BreathProb { get; set; }

        public byte? BackInjury { get; set; }

        public byte? ChronicPain { get; set; }

        public byte? OtherPhysLimit { get; set; }
        ...
        public byte? ModExerPFW { get; set; }

        public byte? VigExerPFW { get; set; }

        public byte? LowFatDietPFW { get; set; }

        public byte? HealthyCarbPFW { get; set; }

        public byte? FeelStressPFW { get; set; }

        public byte? FeelAnxietyPFW { get; set; }
