  ...
  $.fn.foundationSelect = function() {
    ...
    // Check to see if custom dropdowns have already been drawn
      ...
      return this.each(function () {
        ...
        newButton = '<div class="custom-dropdown-area" data-orig-select="#' + selectId + '"' + (multiple ? ' data-multiple="true"' : '') + ' style="z-index: ' + zindexCount + '"><a href="#" data-toggle="select-' + selectId + '" class="custom-dropdown-button">' + selectPrompt + '</a> \
        <ul id="select-' + selectId + '" class="dropdown-pane custom-dropdown-options" data-dropdown data-close-on-click="true"> \
          ' + options + ' \
        </ul></div>';
