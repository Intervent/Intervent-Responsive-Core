        ...
        public HRASummaryModel GetHRAReport(int hraid)
        {
            ...
            if (hraid > 0)
            {
                ...
                if (response.hra != null && response.hra.CompleteDate.HasValue)
                {
                    ...
                    model.measurementsandGoals = ReportUtility.GetMeasurementsandGoals(response.hra, response.hra.Goals, response.hra.User, response.hra.Age.Value, HttpContext.Session.GetInt32(SessionContext.Unit).Value, HttpContext.Session.GetInt32(SessionContext.IntegrationWith));
