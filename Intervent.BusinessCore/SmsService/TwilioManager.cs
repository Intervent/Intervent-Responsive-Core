...
namespace Intervent.Business
{
	public class TwilioManager : BaseManager
	{
		...
		static string fromNoCanada = System.Configuration.ConfigurationManager.AppSettings["TwilioFromCanada"];
		static int SystemAdminId = Convert.ToInt32(System.Configuration.ConfigurationManager.AppSettings["SystemAdminId"]);
